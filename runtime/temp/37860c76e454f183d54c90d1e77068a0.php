<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/MyBlog/public/../application/admin/view/index/index_v1.html";i:1547204037;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="gray-bg">
    <div class="row  border-bottom white-bg dashboard-header">
        ...
        <div class="col-sm-3">
            ...
            <br>
            <br>
            <img src="/static/admin/img/qr_code.png" width="100%" style="max-width:264px;">
            <br>
        </div>
        <div class="col-sm-5">
            <h2>
            ...
            <div class="col-sm-4">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <p id="pay-qrcode">
                            <a href="javascript:;"><img src="/static/admin/img/pay.png" width="100%" alt="请使用手机支付宝或者微信扫码支付">
                            </a>
                        </p>
