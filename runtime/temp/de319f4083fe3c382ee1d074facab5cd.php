<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/var/www/html/MyBlog/public/../application/admin/view/article/admin-classifylist.html";i:1553046519;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#table').bootstrapTable({
                url: '<?php echo url("Article/classifyData"); ?>', //请求地址
                method: 'GET', //请求
                toolbar: '#toolbar',
                striped: true,
                cache: false,
    ...
    function status(obj){
        $.ajax({
            url: '/admin/Article/classifyStatus',
            dataType: 'json',
            type: 'get',
            data: { id: obj },
    ...
    $("#btn_add").click(function () {
        layer.open({
            ...
            title: '添加分组',
            area: ['800px', '90%'],
            content: '<?php echo url("Article/classifyAdd"); ?>'
        });
    })
        ...
        if (i > 1) {
            ...
            if (i != 0) {
                layer.open({
                    ...
                    title: '添加分组',
                    area: ['800px', '90%'],
                    content: '<?php echo url("Article/classifyEdit"); ?>?id='+id,
                });
            } else {
                alert("请选中要编辑的数据");
            }
...
<script type="text/javascript">
    function edits(){
        layer.open({
            ...
            title: '添加分组',
            area: ['800px', '90%'],
            content: '<?php echo url("Account/groupAdd"); ?>'
        });
    }
</script>
</body>
