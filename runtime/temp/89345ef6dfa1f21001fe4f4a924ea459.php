<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/var/www/html/MyBlog/public/../application/admin/view/account/admin-grouplist.html";i:1553046519;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#table').bootstrapTable({
                url: '<?php echo url("Account/groupData"); ?>', //请求地址
                method: 'GET', //请求
                toolbar: '#toolbar',
                striped: true,
                cache: false,
        ...
        if (i > 1) {
            ...
            if (i != 0) {
                ...
                layer.open({
                    ...
                    title: '添加分组',
                    area: ['800px', '90%'],
                    content: '<?php echo url("Account/groupEdit"); ?>?id='+id,
                });
            } else {
                alert("请选中要编辑的数据");
            }
