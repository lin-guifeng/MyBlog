<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/MyBlog/public/../application/admin/view/index/index_v2.html";i:1547023245;}*/ ?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="feed-activity-list">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/static/admin/img/profile.jpg">
                                    </a>
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/static/admin/img/a2.jpg">
                                    </a>
                                    <div class="media-body ">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/static/admin/img/a3.jpg">
                                    </a>
                                    <div class="media-body ">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/static/admin/img/a5.jpg">
                                    </a>
                                    <div class="media-body ">
