<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/usr/share/nginx/html/MyBlog/public/../application/index/view/index/index.html";i:1539340659;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
    ...
    <div role="navigation"  class="site-nav  primary-menu">
        ...
        <ul id="menu-navigation" class="menu">
            ...
            <ul class="sub-menu">
                  ...
                  <li><a target="_blank" href="#"><i class="icon-wordpress"></i>模板下载</a></li>
                </ul>
      </div>
            </div>
...
<div id="footer" class="two-s-footer clearfix">
    ...
    <div class="container">
              ...
              <div class="nav-footer"> <a>首页</a> <a href="#">wordpress专题</a> <a href="#">域名主机</a> <a href="#">wordpress主题</a> <a>页面模版</a> <a href="#">模板下载</a> </div>
              <div class="copyright-footer">
        <p>Copyright © 2018 <a class="site-link" href="#" title="lmlblog" rel="home">lmlblog</a> · Powered By WordPress · Grace Theme By <a href="#" target="_blank">maolai</a></p>
      </div>
