<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/MyBlog/public/../application/admin/view/index/index.html";i:1547176731;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="/admin/index/index_v1.html" data-index="0">主页示例一</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/admin/index/index_v2.html">主页示例二</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/admin/index/index_v3.html">主页示例三</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/admin/index/index_v4.html">主页示例四</a>
                            </li>
                            <li>
                                <a href="/admin/index/index_v5.html" target="_blank">主页示例五</a>
                            </li>
                        </ul>

                    </li>
                    <li>
                        <a class="J_menuItem" href="/admin/index/article_list.html"><i class="fa fa-columns"></i> <span class="nav-label">文章列表</span></a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li><a href="/admin/login/login.html" target="_blank">登录页面</a>
                                    </li>
                                    <li><a href="/admin/login/login_v2.html" target="_blank">登录页面v2</a>
                                    </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/admin/index/index_v1.html?v=4.0" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
