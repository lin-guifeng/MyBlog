                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Account/accountList'); ?>">管理员列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Account/groupList'); ?>">分组管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Account/recordList'); ?>">登录日志</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo url('article/articleList'); ?>">文章列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('article/classifyList'); ?>">分类列表</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Picture/lunboList'); ?>">轮播图</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Picture/groupList'); ?>">相册</a>
                            </li>
                            <li>
