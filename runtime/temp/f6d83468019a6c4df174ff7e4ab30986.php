<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/var/www/html/MyBlog/public/../application/admin/view/picture/admin-pictureadd.html";i:1553079713;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="form1" action="#" method="post" onsubmit="return false">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">导入数据量（30条/批）</label>
                            <div class="col-sm-4">
...
<script>
    $('.btn').click(function (e){
        ...
        $.ajax({
            ...
            url: "<?php echo url('picture/pictureAdd'); ?>" ,//url
            data: $('#form1').serialize(),
            success: function (res) {
                layer.closeAll('loading');
                console.log(res);
                if(res.code=='1'){
                    parent.location="<?php echo url('picture/pictureList'); ?>";
                }
            },
            error : function(res) {
                console.log(res);
