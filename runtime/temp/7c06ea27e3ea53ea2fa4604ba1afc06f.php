<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"/var/www/html/MyBlog/public/../application/index/view/index/index.html";i:1553656963;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<article> 
  ...
  <div class="lbox"> 
    ...
    <div class="whitebg bloglist">
      ...
      <div class="list">
        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <a href="<?php echo url('Index/info'); ?>?id=<?php echo $vo['id']; ?>" class="box1" style="background-color: #fff;height: 220px;">
          <h3>个人博客，属于我的小世界！</h3>
          <div class="newsl">
          ...
          <div class="newsr">
            ...
            <div style="height: 30px;line-height: 30px;">
                ...
                <div style="float: left;margin: 0 15px 0 0;color: #748594;font-size: 12px;">
